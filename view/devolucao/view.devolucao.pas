...
procedure Tf_devolucao.ac_sairExecute(Sender: TObject);
begin
     self.Close;
end;

procedure Tf_devolucao.EditIDKeyPress(Sender: TObject; var Key: char);
begin

end;

procedure Tf_devolucao.ed_ProdutoIDKeyPress(Sender: TObject; var Key: char);
...
procedure Tf_devolucao.FormClose(Sender: TObject;
  var CloseAction: TCloseAction);
begin

end;

procedure Tf_devolucao.FormCloseQuery(Sender: TObject; var CanClose: boolean);
begin
...
procedure Tf_devolucao.Action2Execute(Sender: TObject);
...
procedure Tf_devolucao.ac_cancelarExecute(Sender: TObject);
begin
  f_devolucao.close;
end;

procedure Tf_devolucao.ac_gravarExecute(Sender: TObject);
var _condicional : TCondicional;
begin
   try
        _condicional := TCondicional.Create;
...
procedure Tf_devolucao.FormShow(Sender: TObject);
begin
...
procedure Tf_devolucao.frameProdutoGet1Click(Sender: TObject);
begin

end;

procedure Tf_devolucao.Panel5Click(Sender: TObject);
begin

end;

procedure Tf_devolucao.SetLayout;
var i : Integer;
  _item : TJsonObject;
