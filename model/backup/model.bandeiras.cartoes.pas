...
uses
  ...
  function bandeira_cartoes(_firstUpload:boolean = false; value_json: String = '{}' ) : boolean;
   ...
   try
      ...
      Begin
            ...
            Begin
                 Close;
                 Sql.Clear;
                 Sql.Add('select * from bandeira_cartoes where id = '+QuotedStr(_json.Find('id').AsString));
                 Open;
