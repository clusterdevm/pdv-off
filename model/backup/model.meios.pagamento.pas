...
uses
  ...
  Const _insert_sql = ' insert into meios_pagamento(id, descricao, obs, '+
  ...
  function meios_pagamento(_ArrayItens: TJSONArray ;_data : TConexao = nil) : boolean;
   ...
   try
      ...
      Begin
            ...
            Begin
                 Close;
                 Sql.Clear;
                 Sql.Add('select * from meios_pagamento where id = '+QuotedStr(_json.Find('id').AsString));
                 Open;
