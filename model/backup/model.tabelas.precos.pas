...
uses
  ...
  Const _insert_sql = ' insert into tabela_precos(id, descricao, obs, '+
  ...
  function tabelas_precos(_ArrayItens: TJSONArray ;_data : TConexao = nil) : boolean;
...
{   try
      ...
      Begin
            ...
            Begin
                 Close;
                 Sql.Clear;
                 Sql.Add('select * from tabela_precos where id = '+QuotedStr(_json.Find('id').AsString));
                 Open;
