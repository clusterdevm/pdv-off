...
uses
  ...
  Const _insert_sql = ' insert into produtos_colecoes(id, descricao, obs, '+
  ...
  function produtos_colecoes(_ArrayItens: TJSONArray ;_data : TConexao = nil) : boolean;
   ...
   try
      ...
      Begin
            ...
            Begin
                 Close;
                 Sql.Clear;
                 Sql.Add('select * from produtos_colecoes where id = '+QuotedStr(_json.Find('id').AsString));
                 Open;
